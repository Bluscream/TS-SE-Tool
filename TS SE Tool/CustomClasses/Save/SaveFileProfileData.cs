...
namespace TS_SE_Tool {
    class SaveFileProfileData : SiiNBlockCore {
        private SupportedGame SelectedGame { get; set; }
        public SaveFileProfileData(SupportedGame selectedGame) {
        ...
        public int[] getPlayerLvl() {
            ...
            foreach (int lvlstep in SelectedGame.PlayerLevelUps) {
            ...
            int finalthreshhold = SelectedGame.PlayerLevelUps[SelectedGame.PlayerLevelUps.Count - 1];
